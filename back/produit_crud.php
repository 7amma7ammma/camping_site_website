  ...
  // DELETE: Safe delete with foreign key check
if (isset($_GET['delete'])) {
  $id = $_GET['delete'];

  // Check if product is linked to order_items
  ...
  if ($result['count'] > 0) {
      echo "<script>alert('❌ Ce produit est lié à des commandes existantes et ne peut pas être supprimé.'); window.location='produit_crud.php';</script>";
  } else {
